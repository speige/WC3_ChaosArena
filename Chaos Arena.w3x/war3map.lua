...
function UnitBaseStats(defenseType, attackType, attackRange, attackSpeed, attackDamage, maxLife, startingMana, armor, manaRegen, primaryAttribute, strengthPerLevel, agilityPerLevel, intelligencePerLevel)
    return { defenseType = defenseType, attackType = attackType, attackRange = attackRange, attackSpeed = attackSpeed, attackDamage = attackDamage, maxLife = maxLife, startingMana = startingMana, armor = armor, manaRegen = manaRegen, primaryAttribute = primaryAttribute, strengthPerLevel = strengthPerLevel, agilityPerLevel = agilityPerLevel, intelligencePerLevel = intelligencePerLevel }
end
...
local draftableUnits = {
    akama = UnitMetaData('akama', FourCC('N009'), FourCC('h00S'), FourCC('I001'), FourCC('A01O'), UnitAbilityMetaData(abilities.Immolation, abilities.HardenedSkin, abilities.Taunt), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    alchemist = UnitMetaData('alchemist', FourCC('N000'), FourCC('h00O'), FourCC('I000'), FourCC('A01C'), UnitAbilityMetaData(abilities.HealingSpray, abilities.AcidBomb, abilities.Transmute), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    archimonde = UnitMetaData('archimonde', FourCC('U005'), FourCC('h00N'), FourCC('I002'), FourCC('A01K'), UnitAbilityMetaData(abilities.RainOfChaos, abilities.DarkPortal, abilities.Curse), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    archmage = UnitMetaData('archmage', FourCC('H002'), FourCC('h00C'), FourCC('I003'), FourCC('A011'), UnitAbilityMetaData(abilities.LifeDrain, abilities.Blizzard, abilities.SummonWaterElemental), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    beastmaster = UnitMetaData('beastmaster', FourCC('N001'), FourCC('h00T'), FourCC('I004'), FourCC('A01F'), UnitAbilityMetaData(abilities.SummonBear, abilities.SummonQuilbeast, abilities.Stampede), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    blademaster = UnitMetaData('blademaster', FourCC('O000'), FourCC('h00F'), FourCC('I005'), FourCC('A014'), UnitAbilityMetaData(abilities.CriticalStrike, abilities.MirrorImage, abilities.Bladestorm), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    bloodMage = UnitMetaData('bloodMage', FourCC('H004'), FourCC('h00E'), FourCC('I006'), FourCC('A013'), UnitAbilityMetaData(abilities.FlameStrike, abilities.Banish, abilities.Phoenix), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    ...
    cryptLord = UnitMetaData('cryptLord', FourCC('U003'), FourCC('h00M'), FourCC('I008'), FourCC('A01B'), UnitAbilityMetaData(abilities.Impale, abilities.SpikedCarapace, abilities.LocustSwarm), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    darkRanger = UnitMetaData('darkRanger', FourCC('N007'), FourCC('h00V'), FourCC('I009'), FourCC('A01H'), UnitAbilityMetaData(abilities.Silence, abilities.BlackArrow, abilities.Charm), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    deathKnight = UnitMetaData('deathKnight', FourCC('U000'), FourCC('h00J'), FourCC('I00A'), FourCC('A018'), UnitAbilityMetaData(abilities.DeathCoil, abilities.DeathPact, abilities.AnimateDead), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    demonHunter = UnitMetaData('demonHunter', FourCC('E002'), FourCC('h007'), FourCC('I00B'), FourCC('A00X'), UnitAbilityMetaData(abilities.ManaBurn, abilities.PhaseShift, abilities.Metamorphosis), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    dreadlord = UnitMetaData('dreadlord', FourCC('U002'), FourCC('h00L'), FourCC('I00C'), FourCC('A01A'), UnitAbilityMetaData(abilities.SpiritLink, abilities.Sleep, abilities.CarrionSwarm), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    farSeer = UnitMetaData('farSeer', FourCC('O001'), FourCC('h00G'), FourCC('I00D'), FourCC('A015'), UnitAbilityMetaData(abilities.FeralSpirit, abilities.ChainLightning, abilities.Earthquake), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    firelord = UnitMetaData('firelord', FourCC('N004'), FourCC('h00W'), FourCC('I00E'), FourCC('A01I'), UnitAbilityMetaData(abilities.Incinerate, abilities.SoulBurn, abilities.SummonLavaSpawn), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    guldan = UnitMetaData('guldan', FourCC('O003'), FourCC('h00X'), FourCC('I00F'), FourCC('A01L'), UnitAbilityMetaData(abilities.DiseaseCloud, abilities.HealingWard, abilities.Doom), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    jaina = UnitMetaData('jaina', FourCC('H009'), FourCC('h00Y'), FourCC('I00G'), FourCC('A01M'), UnitAbilityMetaData(abilities.RainOfFire, abilities.HealingWave, abilities.Tornado), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    keeperOfTheGrove = UnitMetaData('keeperOfTheGrove', FourCC('E000'), FourCC('h005'), FourCC('I00H'), FourCC('A00V'), UnitAbilityMetaData(abilities.EntanglingRoots, abilities.ForceOfNature, abilities.Tranquility), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    lich = UnitMetaData('lich', FourCC('U001'), FourCC('h00K'), FourCC('I00I'), FourCC('A019'), UnitAbilityMetaData(abilities.FrostNova, abilities.FrostArmor, abilities.DeathAndDecay), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    mountainKing = UnitMetaData('mountainKing', FourCC('H003'), FourCC('h00D'), FourCC('I00J'), FourCC('A012'), UnitAbilityMetaData(abilities.StormBolt, abilities.Bash, abilities.Avatar), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    murloc = UnitMetaData('murloc', FourCC('N008'), FourCC('h00P'), FourCC('I00K'), FourCC('A01N'), UnitAbilityMetaData(abilities.RaiseDead, abilities.LightningShield, abilities.AerialShackles), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    ogreMauler = UnitMetaData('ogreMauler', FourCC('E004'), FourCC('h008'), FourCC('I00L'), FourCC('A00Y'), UnitAbilityMetaData(abilities.Inferno, abilities.CarrionBeetles, abilities.Volcano), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    paladin = UnitMetaData('paladin', FourCC('H001'), FourCC('h00B'), FourCC('I00M'), FourCC('A010'), UnitAbilityMetaData(abilities.HolyLight, abilities.DivineShield, abilities.Resurrection), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    pitLord = UnitMetaData('pitLord', FourCC('N006'), FourCC('h00Z'), FourCC('I00N'), FourCC('A01J'), UnitAbilityMetaData(abilities.HowlOfTerror, abilities.CleavingAttack, abilities.SpellImmunity), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    priestessOfTheMoon = UnitMetaData('priestessOfTheMoon', FourCC('E001'), FourCC('h006'), FourCC('I00O'), FourCC('A00W'), UnitAbilityMetaData(abilities.ThunderClap, abilities.SearingArrows, abilities.Starfall), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    seaWitch = UnitMetaData('seaWitch', FourCC('N002'), FourCC('h00Q'), FourCC('I00P'), FourCC('A01D'), UnitAbilityMetaData(abilities.ForkedLightning, abilities.FrostArrows, abilities.ManaShield), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    shadowHunter = UnitMetaData('shadowHunter', FourCC('O004'), FourCC('h00I'), FourCC('I00Q'), FourCC('A017'), UnitAbilityMetaData(abilities.Hex, abilities.SerpentWard, abilities.BigBadVoodoo), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    taurenChieftain = UnitMetaData('taurenChieftain', FourCC('O002'), FourCC('h00H'), FourCC('I00R'), FourCC('A016'), UnitAbilityMetaData(abilities.Shockwave, abilities.Reincarnation, abilities.WarStomp), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    tinker = UnitMetaData('tinker', FourCC('N003'), FourCC('h00R'), FourCC('I00S'), FourCC('A01E'), UnitAbilityMetaData(abilities.PocketFactory, abilities.ClusterRockets, abilities.RoboGoblin), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
    warden = UnitMetaData('warden', FourCC('E003'), FourCC('h00A'), FourCC('I00T'), FourCC('A00Z'), UnitAbilityMetaData(abilities.FanOfKnives, abilities.ShadowStrike, abilities.Vengeance), BalanceBaseStatsByPoints(DEFENSE_TYPE.LIGHT, ATTACK_TYPE.NORMAL, HERO_ATTRIBUTE.STRENGTH, 0, BalanceStatPointAllocations(5, 5, 5, 5, 5, 5, 5, 5, 5))),
}
...
local REROLL_ALL_ABILITY_ID = FourCC('A03Y')
