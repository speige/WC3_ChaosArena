...
u = BlzCreateUnitWithSkin(p, FourCC("ncop"), 1088.0, -2304.0, 270.000, FourCC("ncop"))
u = BlzCreateUnitWithSkin(p, FourCC("ncop"), 1216.0, -2304.0, 270.000, FourCC("ncop"))
u = BlzCreateUnitWithSkin(p, FourCC("ncop"), 1344.0, -2304.0, 270.000, FourCC("ncop"))
u = BlzCreateUnitWithSkin(p, FourCC("ncop"), 1344.0, -2176.0, 270.000, FourCC("ncop"))
u = BlzCreateUnitWithSkin(p, FourCC("ncop"), 1216.0, -2176.0, 270.000, FourCC("ncop"))
u = BlzCreateUnitWithSkin(p, FourCC("ncop"), 1088.0, -2176.0, 270.000, FourCC("ncop"))
u = BlzCreateUnitWithSkin(p, FourCC("ncop"), 1088.0, -2048.0, 270.000, FourCC("ncop"))
u = BlzCreateUnitWithSkin(p, FourCC("ncop"), 1216.0, -2048.0, 270.000, FourCC("ncop"))
u = BlzCreateUnitWithSkin(p, FourCC("ncop"), 1344.0, -2048.0, 270.000, FourCC("ncop"))
end
...
SetStartLocPrio(8, 1, 9, MAP_LOC_PRIO_LOW)
...
SetStartLocPrio(10, 0, 9, MAP_LOC_PRIO_LOW)
...
DefineStartLocation(0, 0.0, 2624.0)
DefineStartLocation(1, 1664.0, 2304.0)
DefineStartLocation(2, 2560.0, 1344.0)
DefineStartLocation(3, 2880.0, -256.0)
DefineStartLocation(4, 2496.0, -1920.0)
DefineStartLocation(5, 1600.0, -2624.0)
DefineStartLocation(6, 0.0, -3136.0)
DefineStartLocation(7, -1664.0, -2752.0)
DefineStartLocation(8, -2560.0, -1920.0)
DefineStartLocation(9, -2880.0, -320.0)
DefineStartLocation(10, -2560.0, 1280.0)
DefineStartLocation(11, -1664.0, 2176.0)
DefineStartLocation(12, 0.0, 1728.0)
DefineStartLocation(13, 768.0, 1472.0)
DefineStartLocation(14, 1664.0, 576.0)
DefineStartLocation(15, 1984.0, -320.0)
DefineStartLocation(16, 1664.0, -1152.0)
DefineStartLocation(17, 768.0, -1792.0)
DefineStartLocation(18, 0.0, -2240.0)
DefineStartLocation(19, -768.0, -1984.0)
DefineStartLocation(20, -1664.0, -1152.0)
DefineStartLocation(21, -1920.0, -320.0)
DefineStartLocation(22, -1664.0, 512.0)
DefineStartLocation(23, -832.0, 1408.0)
