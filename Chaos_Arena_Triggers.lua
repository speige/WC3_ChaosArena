...
local abilityIds = {
    AcidBomb = 'A034',
    AerialShackles = 'A003',
    AncestralSpirit = 'A03X',
    AnimateDead = 'A02T',
    Anti_MagicShell = 'A00A',
    Avatar = 'A028',
    Banish = 'A02E',
    Bash = 'A02A',
    BigBadVoodoo = 'A02Q',
    ...
    Inferno = 'A021',
    LifeDrain = 'A004',
    LightningAttack = 'A00K',
    LightningShield = 'A007',
    LocustSwarm = 'A031',
    ManaBurn = 'A01U',
    ManaFlare = 'A00L',
    ManaShield = 'A037',
    ...
    StoneForm = 'A03Y',
    StormBolt = 'A02B',
    Storm_Earth_andFire = 'A03G',
    SummonBear = 'A03B',
    SummonLavaSpawn = 'A03L',
    SummonQuilbeast = 'A03C',
    SummonWaterElemental = 'A029',
    Taunt = 'A00Q',
    ThunderClap = 'A01T',
    Tornado = 'A03U',
    Tranquility = 'A01Q',
